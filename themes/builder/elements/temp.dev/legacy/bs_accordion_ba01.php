<?php 
    ...
    section_class('el-accordion ba01');
    div_start('dflex', array('data'=>data_set($opt)));
?>

<div class="container-xl" data-accordion>         
    <div class="acc-content" id="acc-content<?php _e($acc); ?>">
        <?php 
        $rp = $e['items'];
        ...
        ?>
            ...
            <div class="item item-<?php _e($i); ?>">

                <div class="ihead dflex-space collapsed" 
                     data-toggle="collapse" data-target="#idrop<?php _e($i); ?>" 
                     aria-expanded="true">
...
$(function() {
    ...
    setTimeout(function() {
        $('.item:first-child .ihead').trigger('click');
    }, 1);
    <?php endif; ?>
