...
class PREFIX_acf_field_FIELD_NAME extends \acf_field {
	...
	public function render_field_settings( $field ) {
		...
		acf_render_field_setting(
			...
			array(
				...
				'name'			=> 'is_popup',
				'type'			=> 'true_false',
				'message'   	=> 'View content using a lightbox',
			),
		);
	...
	public function render_field( $field ) {
		...
		<a href="#" class="button" data-name="meso" target="">MESO</a>
		</div>
	...
	public function input_admin_enqueue_scripts() {
		...
		wp_register_script( 'PREFIX-FIELD-NAME', 
		$tpath . "/functions/builder/assets/js/field.js", array( 'acf-input' ), $version);

		wp_register_style(
			'PREFIX-FIELD-NAME',
			$tpath . "/functions/builder/assets/css/field.css",
			array( 'acf-input' ),
			$version
		);
