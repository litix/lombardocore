...
if(!class_exists('acfe_field_pop_media')):

class acfe_field_pop_media extends acf_field{
    
    function initialize(){

        $this->name = 'acfe_pop_media';
        $this->label = __('Pop Media', 'acfe');
    ...
    function render_field($field){
        ...
        <div <?php echo acf_esc_attrs($div); ?>>
            ...
            <a href="#" class="button pop_field" data-name="add" target=""><?php _e('Select Link', 'acf'); ?></a>
    ...
    function get_sub_fields($field){
        ...
        $sub_fields[] = array(
            ...
            'ui'                => 1,
            'ajax'              => 1,
            'ajax_action'       => 'acfe/fields/pop_media/post_query',
        ...
        // deprecated
        $sub_fields = apply_filters_deprecated('acfe/fields/pop_media/fields',                         array($sub_fields, $field, $value), '0.8.1', 'acfe/fields/pop_media/sub_fields');
        $sub_fields = apply_filters_deprecated('acfe/fields/pop_media/fields/name=' . $field['_name'], array($sub_fields, $field, $value), '0.8.1', 'acfe/fields/pop_media/sub_fields/name=' . $field['_name']);
        $sub_fields = apply_filters_deprecated('acfe/fields/pop_media/fields/key=' . $field['key'],    array($sub_fields, $field, $value), '0.8.1', 'acfe/fields/pop_media/sub_fields/key=' . $field['key']);
...
// initialize
acf_register_field_type('acfe_field_pop_media');
