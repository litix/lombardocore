...
$pop_btns_new = array (/* your buttons */);

$pop_btns = array_merge(
                $pop_btns_text, 
                $pop_btns_icon,
                $pop_btns_new,
            );

define ("POP_BTNS", $pop_btns);   

/* ---------------------------------------------------------- */


if(!class_exists('billy_pop_button')):

class billy_pop_button extends \acf_field{
    ...
    public function __construct() {
        ...
        $this->name = 'acfe_pop_button';
        $this->label = __('Pop Button', 'acfe');
    ...
    public function render_field($field){
        ...
        <div class="pop-field">
            ...
            <a href="#" class="button pop-modal" data-name="add" target=""><?php _e('Select Link', 'acf'); ?></a>
    ...
    function get_sub_fields($field){
        ...
        */       
        ...
        $sub_fields[] = array (
            ...
            'conditional_logic' => array(
                array(
                    array('field' => 'design', 'operator' => '!=', 'value' => 'btn-1'),
                    array('field' => 'design', 'operator' => '!=', 'value' => 'btn-2'),
                    array('field' => 'design', 'operator' => '!=', 'value' => 'btn-3'),
                    array('field' => 'design', 'operator' => '!=', 'value' => 'btn-3a'),                    
                    array('field' => 'design', 'operator' => '!=', 'value' => 'more'),
                    array('field' => 'design', 'operator' => '!=', 'value' => 'btn-4'),
                    array('field' => 'design', 'operator' => '!=', 'value' => 'btn-5'),
                    array('field' => 'design', 'operator' => '!=', 'value' => 'btn-6'),                    
                    array('field' => 'design', 'operator' => '!=', 'value' => 'btn-7'),                    
                )
            )             	     
        );
        ...
        $sub_fields[] = array(
            ...
            'label'     => 'Modal',
            'type'      => 'true_false',
            'message'   => 'Iframe (url) or Modal (#id)',
            'ui'        => false,
        ...
        // filters
        $sub_fields = apply_filters('acfe/fields/pop_button/sub_fields',                         $sub_fields, $field, $value);
        $sub_fields = apply_filters('acfe/fields/pop_button/sub_fields/name=' . $field['_name'], $sub_fields, $field, $value);
        $sub_fields = apply_filters('acfe/fields/pop_button/sub_fields/key=' . $field['key'],    $sub_fields, $field, $value);
...
// initialize
acf_register_field_type('billy_pop_button');
