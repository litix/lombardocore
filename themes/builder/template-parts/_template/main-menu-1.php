...
<div class="menu_wrap">
    <div class="container-xl">  
        <?php get_template_part('template-parts/_template/menu/menu-home', '1'); ?>  
        <?php get_template_part('template-parts/_template/menu/menu-float'); ?>   
        <?php get_template_part('template-parts/_template/menu/menu-mobile', '1'); ?>        
    </div>  
</div>        
</header>  
