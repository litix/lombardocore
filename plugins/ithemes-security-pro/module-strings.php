...
__( 'Determine how iThemes Security determines your visitor‘s IP addresses. Choose the Security Check Scan to increase iThemes Security’s ability to identify your server IP and IPs attacking your website accurately.', 'it-l10n-ithemes-security-pro' );
...
__( 'Enable Grade Report', 'it-l10n-ithemes-security-pro' );
__( 'The Grade Report feature can help you identify vulnerabilities on the site. Visit the Notification Center to select which users receive emails from this feature.', 'it-l10n-ithemes-security-pro' );
...
# BEGIN MODULE: grade-report
__( 'Grade Report', 'it-l10n-ithemes-security-pro' );
__( 'See your WordPress security grade and fix issues.', 'it-l10n-ithemes-security-pro' );
__( 'Enable Grade Report Access', 'it-l10n-ithemes-security-pro' );
__( 'Allow users to view the Grade Report.', 'it-l10n-ithemes-security-pro' );
# END MODULE: grade-report
...
__( 'Google reCAPTCHA helps keep bad bots from engaging in abusive activities on your website, such as attempting to break into your website using compromised passwords, posting spam, or fraudulently triggering password reset requests.<br>Legitimate users will be able to log in, make purchases, view pages, or create accounts. reCAPTCHA uses advanced risk analysis techniques to tell humans and bots apart.', 'it-l10n-ithemes-security-pro' );
...
__( 'The generated site key from the Google reCAPTCHA dashboard.', 'it-l10n-ithemes-security-pro' );
__( 'Secret Key', 'it-l10n-ithemes-security-pro' );
__( 'The generated secret key from the Google reCAPTCHA dashboard.', 'it-l10n-ithemes-security-pro' );
...
__( 'To assist with GDPR compliance, iThemes Security can prompt the user to accept Google’s Privacy Policy and Terms of Service before loading the reCAPTCHA API.', 'it-l10n-ithemes-security-pro' );
__( 'On Page Opt-in', 'it-l10n-ithemes-security-pro' );
__( 'Allow users to opt-in to reCAPTCHA without refreshing the page.', 'it-l10n-ithemes-security-pro' );
...
__( 'The numbers of failed reCAPTCHA entries that will trigger a lockout. Set to zero (0) to record recaptcha errors without locking out users. This can be useful for troubleshooting content or other errors. The default is 7.', 'it-l10n-ithemes-security-pro' );
